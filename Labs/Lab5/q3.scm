...
; Date: 9/25/2020
; Class: CSCE 314
; Description: q3 asked us to define a function that would return t if the place passed
; as a parameter was in the world-tree2 as a node. However, a working function for 
; this problem was already present in the provided code. We notified our professor about
; the issue and proceeded with remaining questions.
...
(display (in-tree? 'australia world-tree2))
(newline)

(display (in-tree? 'bangladesh world-tree2))
(newline)
