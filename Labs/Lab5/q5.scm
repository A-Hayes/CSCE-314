...
; Class: CSCE 314
; Description: 
; q5 asked us to define the path-tree function that would return the path where the city/country parameter
; could be found in the passed tree. 
; However, a working function for this problem was already present in the provided code. We notified our professor about
; the issue.
...
; alt to path-tree already tree
(display (locate 'victoria world-tree2))
